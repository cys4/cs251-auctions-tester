...
//console.log(args[0], args[1], args[2] );    // yschoi 
//return    // yschoi
...
for (var contractName in compilationResults.contracts) {  // yschoi
    ...
    console.log(contractCode+"\["+contractName+"\] = "+contractName);   // yschoi
    //break;      // yschoi
}
